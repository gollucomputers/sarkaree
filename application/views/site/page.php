	...
	<div class="home">
        ...
        <?php $newsitem=0; foreach($newsforslider as $row): ?>
	<?php if($newsitem>2) break; $newsitem++; ?>
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(<?php echo base_url(); ?>assets/uploads/<?php echo $row->image; ?>)"></div>
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content">
										<div class="home_slider_item_category trans_200"><a href="category.html" class="trans_200">Railway</a></div>
										<div class="home_slider_item_title">
											<a href="<?php echo base_url().'home/news/'.$row->news_id; ?>"><?php echo mb_substr($row->title, 0,120); ?></a>
										</div>
										<div class="home_slider_item_link">
											<a href="<?php echo base_url().'home/news/'.$row->news_id; ?>" class="trans_200">Continue Reading
        ...
        <?php endforeach; ?>  
         ...
         <?php foreach($newsforsliderside as $row): ?>
							<div class="home_slider_next" style="background-image:url(<?php echo base_url(); ?>assets/uploads/<?php echo $row->image; ?>)">
								...
								<div class="home_slider_next_content trans_400">
									...
									<div class="home_slider_next_link"><?php echo mb_substr($row->title, 0,120); ?></div>
								</div>
							</div>
  ...
  <?php foreach($catsc as $row): ?>
      ...
      <?php endforeach; ?>     
        ...
        <?php $card=0; $cardnum=array(1,2,3,4,5);
