    ...
    <dd>
        <div class="mutliSelect">
            <ul>
                ...
                <li>
                    <input name="tags[]" type="checkbox" value="<?php echo $row->tag_id; ?> " <?php if(in_array($row->tag_id , $tagsdata)) echo  "checked"; ?> title="<?php echo $row->title; ?>" /><?php echo ' '.$row->title; ?></li>
			<?php endforeach; ?>
            </ul>
        </div>
    </dd>
