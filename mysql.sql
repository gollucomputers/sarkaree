...
CREATE TABLE `comments` (
  `commnt_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `relative_tags`
--

DROP TABLE IF EXISTS `relative_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `relative_tags` (
  `tag_id` int(11) NOT NULL,
  `news_id` int(11) NOT NULL,
  UNIQUE KEY `fk_news_unique` (`tag_id`,`news_id`),
  KEY `fk_news_id` (`news_id`),
  CONSTRAINT `fk_news_id` FOREIGN KEY (`news_id`) REFERENCES `news` (`news_id`),
  CONSTRAINT `fk_tags_id` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`tag_id`)
...
-- Dump completed on 2018-10-13 19:40:33
